...
const Footer = () => {
  return (
    <div
      className={`bg-lightGrey ${styles.paddingX} ${styles.flexCenter}`}
    >
      <div className={`${styles.boxWidth} justify-items-center`}>
        <div className="h-auto flex justify-between lg:px-24 px-2 md:flex-row flex-col pt-10 mb-10">
          <div className="flex flex-col">
            ...
            <h2 className="text-white py-1 max-w-[238px] pl-2">
              NFT marketplace UI created with Anima for Figma.
            </h2>
            <h2 className="text-white py-1 pl-2 pt-1">Join our community</h2>
            <div className="flex">
          ...
          <div className="flex flex-col justify-between mb-4">
            ...
            <h2 className="text-white text-[16px]">Marketplace</h2>
            <h2 className="text-white text-[16px]">Rankings</h2>
            <h2 className="text-white text-[16px]">Connect a wallet</h2>
          </div>
          <div className="flex-col">
            <h2 className="text-[22px] md:max-w-[400px] pb-5 font-semibold leading-[35.2px] text-white">
              Join Our Weekly Digest
            </h2>
            <h2 className="text-[16px] md:max-w-[450px] font-normal leading-[22.4px] text-white">
